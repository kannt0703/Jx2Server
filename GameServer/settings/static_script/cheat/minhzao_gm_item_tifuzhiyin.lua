...
function get_all()
	local tSay = {
		...
		"Qu©n hµm nguyªn so¸i vµ qu©n c«ng/quanham_soai",
		"NhËn Vò KhÝ Nguyªn Tö/vknt",
		"NhËn Set Thiªn H¹ V« Song/thvs",
		"NhËn Set L«i Hæ So¸i/nhanlht",
		...
		"Reload thÎ/ReloadScript",
		"NhËn ®Êu hån/nhandauhon",
		"NhËn vÐ tiÕu y/nhanvetieuy",
		"Xãa tÊt c¶ item/ClearBagAllItem",
		"T¹i h¹ chØ xem qua th«i/nothing",
	}
...
function nhanlht()
	...
	AddItem(0,100,30222,1,1,-1,-1,-1,-1,-1,-1,-1,15);
	AddItem(0,101,30222,1,1,-1,-1,-1,-1,-1,-1,-1,15);
	AddItem(0,103,30222,1,1,-1,-1,-1,-1,-1,-1,-1,15);
	AddItem(0,100,30221,1,1,-1,-1,-1,-1,-1,-1,-1,15);
	AddItem(0,101,30221,1,1,-1,-1,-1,-1,-1,-1,-1,15);
	AddItem(0,103,30221,1,1,-1,-1,-1,-1,-1,-1,-1,15);
	AddItem(0,100,30220,1,1,-1,-1,-1,-1,-1,-1,-1,15);
	AddItem(0,101,30220,1,1,-1,-1,-1,-1,-1,-1,-1,15);
	AddItem(0,103,30220,1,1,-1,-1,-1,-1,-1,-1,-1,15);
	AddItem(0,100,30219,1,1,-1,-1,-1,-1,-1,-1,-1,15);
	AddItem(0,101,30219,1,1,-1,-1,-1,-1,-1,-1,-1,15);
	AddItem(0,103,30219,1,1,-1,-1,-1,-1,-1,-1,-1,15);
end
...
function thucuoipro()
	...
	AddItem(0,105,30057,1,1,7,403,7,-1,7,-1,7,0);
	AddItem(0,105,30058,1,1,7,403,7,-1,7,-1,7,0);
	AddItem(0,105,30059,1,1,7,403,7,-1,7,-1,7,0);
	AddItem(0,105,30052,1,1,7,403,7,-1,7,-1,7,0);
	AddItem(0,105,163,1,1,7,403,7,-1,7,-1,7,0);
	AddItem(0,105,161,1,1,7,403,7,-1,7,-1,7,0);
	AddItem(0,105,30056,1,1,7,403,7,-1,7,-1,7,0);
	AddItem(0,105,30053,1,1,7,403,7,-1,7,-1,7,0);
...
function ngoaitrangtocdanh()
	...
	AddItem(0,109,15,1,1,7,276,7,276,7,276,7,0);
	AddItem(0,110,15,1,1,7,276,7,276,7,276,7,0);
	AddItem(0,108,15,1,1,7,276,7,276,7,276,7,0);
end
...
function ngoaitrangdame()
	...
	AddItem(0,109,15,1,1,7,252,7,252,7,252,7,0);
	AddItem(0,110,15,1,1,7,252,7,252,7,252,7,0);
	AddItem(0,108,15,1,1,7,252,7,252,7,252,7,0);
end
