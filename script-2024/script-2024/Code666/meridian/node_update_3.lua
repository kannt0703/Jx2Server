--[[
    ...
    M« t¶: Module nµy chøa c¸c hµm kiÓm tra xem ng­êi ch¬i ®· ®¸p øng ®iÒu kiÖn
           ®Ó kİch ho¹t mét huyÖt vŞ cô thÓ (trong tr­êng hîp nµy lµ huyÖt vŞ cã ID lµ 3) hay ch­a.
...
t_node_id_list = {3}  -- HuyÖt vŞ víi ID 3 lµ ®èi t­îng cÇn kiÓm tra trong vİ dô nµy

-- Danh s¸ch c¸c huyÖt vŞ ®iÒu kiÖn vµ cÊp ®é yªu cÇu t­¬ng øng
t_require_node_list = {
    {51, "ThiÕu Xung", _get_require_level},  -- HuyÖt vŞ "ThiÕu Xung" (ID 51) lµ ®iÒu kiÖn, cÊp ®é yªu cÇu tİnh b»ng hµm _get_require_level
}
